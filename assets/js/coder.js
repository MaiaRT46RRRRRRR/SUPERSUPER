...
imprimir.innerHTML = "";
    ...
    coders.forEach(function(elem){
      imprimir.innerHTML += "<div class='coder'><p>Nombre: "+ elem.nombre + "</p>"+
      "<p>Nombre: "+ elem.apellido + "</p>"+
      "<p>Nombre: "+ elem.promocion + "</p>"+
      "<p>Nombre: "+ elem.estado + "</p>"+ "</div>" ;
    } );